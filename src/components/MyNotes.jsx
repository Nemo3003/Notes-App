...
//Notes component. Here we will create the notes.
const MyNotes = () => {
          ...
          <ul className="list-group list-group-flush">
            {filteredNotes.map((note) => (
              <li className="list-group-item" key={note.id}>
                <input onChange={handleActivation}  type="checkbox" id="inactive" name="inactive" value="Inactive"></input>
                <label for="inactive"> done?</label>
                <input onChange={handleDeactivation} type="checkbox" id="active" name="active" value="active"></input>
                <label for="active"> not done?</label>
        ...
        >
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              {/**This will allow us to edit the notes */}
